...
syn region eximString start=+"+ skip=+\\\\\|\\"+ end=+"+ contains=eximSpecialChar,eximLineContinuation,eximListChanger,eximVariableReference,eximExpansionVariable
...
syn match eximVariableReference "\$h_[-a-zA-Z0-9_]\+\>"
...
" 13.9. Daemon
syn keyword eximOption daemon_smtp_ports local_interfaces pid_file_path
...
syn keyword eximOption smtp_max_synprot_errors add_environment keep_environment
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""" }}}
...
syn keyword eximOption bcc cc file from headers log mode once once_file_size once_repeat reply_to subject text to mail
